    ...
    const features = [
        {
            ...
            desc: 'GPT-4o-mini detects nuanced emotional states, context, and character moods from any script.',
            tag: 'PHASE 2',
        },
        {
    ...
    return (
        <div className="min-h-screen relative overflow-hidden font-body">
            ...
            <footer className="relative z-10 border-t border-white/5 py-8 px-6">
                <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6 text-xs text-white/30">
                    <div className="flex flex-col gap-1 text-center md:text-left">
                        <span>© 2026 Lumina AI - Lighting Automation</span>
                        <span className="font-mono text-[10px] text-[#00d4ff]/60">Built with GPT-4o-mini • RAG • Three.js</span>
                    </div>
                    <div className="flex flex-col items-center md:items-end gap-1 font-mono text-[10px] uppercase tracking-wider backdrop-blur-sm bg-black/20 p-4 rounded-xl border border-white/5 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)]">
                        <span className="text-[#00d4ff]/80 text-[9px] mb-1 tracking-[0.2em] uppercase font-bold text-center md:text-right w-full block">Guided By</span>
                        <div className="text-white/70 font-bold mb-3 hover:text-[#00d4ff] transition-colors duration-300">
                            Dr. THIRUNAVUKKARASU V
                        </div>

                        <span className="text-[#00d4ff]/80 text-[9px] mb-2 tracking-[0.2em] uppercase font-bold text-center md:text-right w-full block pt-2 border-t border-white/5">Project By</span>
                        <div className="flex flex-col md:flex-row gap-x-4 gap-y-2 text-white/50 items-center">
                            <span className="hover:text-[#00d4ff] transition-colors duration-300">Nishit Daruwala - 2548518</span>
                            <span className="hidden md:inline text-white/10">|</span>
                            <span className="hover:text-[#00d4ff] transition-colors duration-300">Ram Kapadia - 2548530</span>
                            <span className="hidden md:inline text-white/10">|</span>
                            <span className="hover:text-[#00d4ff] transition-colors duration-300">Hitesh Kumar - 2548525</span>
                        </div>
                    </div>
                </div>
            </footer>
